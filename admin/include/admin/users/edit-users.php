<?php 
    if (isset($_GET['data'])) {
        ...
        // get profil user
        $sql = "SELECT `nama`, `jenis_kelamin`, `alamat`, `no_telp`, `username`, `password`, `foto`, `users`.`id_role`, `role`.`role`  
                FROM `users`
...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h4 mb-3 text-gray-800">Edit Users</h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4 border-primary">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-dark card-title">Form Edit Users</h6>
                            ...
                            <div class="card mb-4 border-primary">
                                <div class="card-body">
                                    <?php if (!empty($_GET['notif'])) : ?>
                                        ...
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    <form action="index.php?include=konfirmasi-edit-users" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="mb-5">
                                                    ...
                                                    <select class="form-control" name="role" id="role">
                                                        ...
                                                        <?php while ($data = mysqli_fetch_assoc($query)) :
                                                            ...
                                                            $role = $data["role"];
                                                        ?>
                                                            <option value="<?= $id_role; ?>" <?php if($id_role == $id_roleUser) { ?> selected <?php } ?>><?= $role; ?></option>
                                                        <?php endwhile; ?>
                                                    </select>
                                                </div>
