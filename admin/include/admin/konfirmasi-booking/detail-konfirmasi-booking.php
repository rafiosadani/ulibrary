...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h4 mb-3 text-gray-800">Detail Konfirmasi Booking Buku</h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow border-primary">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-dark card-title">Form Detail Konfirmasi Booking Buku</h6>
                    <div class="card-tools">
                        <a href="index.php?include=konfirmasi-booking" class="btn btn-primary btn-sm float-right"><i class="fas fa-fw fa-solid fa-arrow-left"></i> Kembali</a>
                    </div>
                </div>
                            ...
                            <nav aria-label="Page navigation example">
                                ...
                                <?php 
                                    if ($jum_halaman == 0) {
                                        ...
                                        if ($halaman != 1) {
                                        echo "<li class='page-item'><a class='page-link' href='index.php?include=detail-konfirmasi-booking&data=" . $kode_peminjaman . "&halaman=1'>First</a></li>";
                                        echo "<li class='page-item'><a class='page-link' href='index.php?include=detail-konfirmasi-booking&data=" . $kode_peminjaman . "&halaman=$sebelum'>&laquo;</a></li>";
                                        }
                                        for ($i = 1; $i <= $jum_halaman; $i++) {
                                            if ($i > $halaman - 5 and $i < $halaman + 5 ) {
                                                if ($i != $halaman) { 
                                                    echo "<li class='page-item'><a class='page-link' href='index.php?include=detail-konfirmasi-booking&data=" . $kode_peminjaman . "&halaman=$i'>$i</a></li>";
                                                } else {
                                        ...
                                        echo "<li class='page-item'><a class='page-link' href='index.php?include=detail-konfirmasi-booking&data=" . $kode_peminjaman . "&halaman=$setelah'>»</a></li>";
                                        echo "<li class='page-item'><a class='page-link' href='index.php?include=detail-konfirmasi-booking&data=" . $kode_peminjaman . "&halaman=$jum_halaman'>Last</a></li>";
                                        }          
                                    }
                                ?>
                                </ul>
