<?php 
    ...
    if(isset($_GET["aksi"]) && isset($_GET["data"])) {
        if($_GET["aksi"] == "hapus") {
            ...
            // get gambar buku
            $sql_dl_gambar = "SELECT `gambar` FROM `buku` WHERE `id_buku` = '$id_buku'";
...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h4 mb-3 text-gray-800">Buku</h1>
            ...
            <div class="card border-primary">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <div class="card-tools">
                        <a href="index.php?include=tambah-buku" class="btn btn-primary btn-sm float-right"><i class="fas fa-fw fa-plus"></i> Tambah Buku</a>
                    </div>
                </div>
                <div class="card-body p-3">
                    <div class="row mb-2">
                        <div class="col-md-5">
                            <form class="navbar-search" action="index.php?include=buku" method="post">
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="font-size: 14px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a href="index.php?include=detail-buku&data=<?= $id_buku; ?>" class="badge badge-primary"><i class="fas fa-fw fa-regular fa-eye"></i></a> | <a href="index.php?include=edit-buku&data=<?= $id_buku; ?>" class="badge badge-success"><i class="fas fa-fw fa-edit"></i></a> | <a href="javascript:if(confirm('Anda yakin ingin menghapus data Buku <?= $judul; ?>?'))window.location.href = 'index.php?include=buku&aksi=hapus&data=<?= $id_buku; ?>&notif=hapusBerhasil'" class="badge badge-danger"><i class="fas fa-fw fa-trash"></i></a>
                                    </td>
                                </tr>
                                <?php $no++; ?>
                                <?php endwhile; ?>
