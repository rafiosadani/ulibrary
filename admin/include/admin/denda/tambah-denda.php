<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h4 mb-3 text-gray-800">Tambah Denda</h1>
        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow mb-4 border-primary">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-dark card-title">Form Tambah Denda</h6>
                ...
                <div class="card-body">
                    ...
                    <div class="card mb-4 shadow border-primary">
                        <div class="card-body">
                            <form action="index.php?include=konfirmasi-tambah-denda" method="post">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                        ...
                                        <button type="submit" class="btn btn-primary float-right" name="submit">Tambah Denda</button>
                                    </div>
                                </div>
                            </form>
                        </div>
