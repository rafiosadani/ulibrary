...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h4 mb-3 text-gray-800">Laporan Data Peminjaman</h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="card border-primary">
                ...
                <div class="card-body p-3">
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <form class="navbar-search" action="index.php?include=laporan-data-peminjaman" method="post">
                    ...
                    <form action="index.php?include=laporan-data-peminjaman" method="post">
                    <div class="row mb-1">
                        <div class="col-md-5">
                            <div class="row mb-3">
                                <div class="col-md-3">
                        ...
                        <tbody>
                            <?php
                                ...
                                if (!empty($katakunci_kode)) {
                                    ...
                                    $sql .= " AND `peminjaman`.`tgl_pinjam` BETWEEN '$tgl1' AND '$tgl2'";
                                }
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-dark text-center"><span class="badge rounded-pill text-white bg-primary"><?= $status; ?></span></td>
                            </tr>
                            <?php $no++; ?>
                            <?php endwhile; ?>
                        </tbody>
                    ...
                    <?php
                        ...
                        if (!empty($katakunci_kode)) {
                            ...
                            $sql_jum .= " AND `peminjaman`.`tgl_pinjam` BETWEEN '$tgl1' AND '$tgl2'";
                        } 
                    ...
                    <nav aria-label="Page navigation example">
                        ...
                        <?php 
                            if ($jum_halaman == 0) {
                                ...
                                if ($halaman != 1) {
                                echo "<li class='page-item'><a class='page-link' href='index.php?include=laporan-data-peminjaman&halaman=1'>First</a></li>";
                                echo "<li class='page-item'><a class='page-link' href='index.php?include=laporan-data-peminjaman&halaman=$sebelum'>&laquo;</a></li>";
                                }
                                for ($i = 1; $i <= $jum_halaman; $i++) {
                                    if ($i > $halaman - 5 and $i < $halaman + 5 ) {
                                        if ($i != $halaman) { 
                                            echo "<li class='page-item'><a class='page-link' href='index.php?include=laporan-data-peminjaman&halaman=$i'>$i</a></li>";
                                        } else {
                                ...
                                echo "<li class='page-item'><a class='page-link' href='index.php?include=laporan-data-peminjaman&halaman=$setelah'>»</a></li>";
                                echo "<li class='page-item'><a class='page-link' href='index.php?include=laporan-data-peminjaman&halaman=$jum_halaman'>Last</a></li>";
                                }          
                            }
                        ?>
                        </ul>
