...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h4 mb-3 text-gray-800">Detail Transaksi Pengembalian Buku</h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow border-primary">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-dark card-title">Form Detail Transaksi Pengembalian Buku</h6>
                    <div class="card-tools">
                        <a href="index.php?include=pengembalian" class="btn btn-primary btn-sm float-right"><i class="fas fa-fw fa-solid fa-arrow-left"></i> Kembali</a>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="font-size: 13px;">
                                <thead>
                                    ...
                                    <th class="text-dark" width="50%">Judul Buku</th>
                                    <th class="text-dark" width="15%" style="text-align: center;">Jumlah Buku</th>
                                    <th class="text-dark" width="15%" style="text-align: center;">Keterangan</th>
                                    <th class="text-dark" width="15%" style="text-align: center;">Denda</th>
                                </thead>
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT  `detail_peminjaman`.`id_buku`, `detail_peminjaman`.`jumlah_buku`, 
                                                        `detail_peminjaman`.`keterangan_denda`, `detail_peminjaman`.`total_denda`, 
                                                        `buku`.`judul`
                                                FROM `detail_peminjaman` 
                                                INNER JOIN `buku` ON `detail_peminjaman`.`id_buku` = `buku`.`id_buku`  
                                                WHERE `detail_peminjaman`.`status` = 'Kembali' AND `detail_peminjaman`.`kode_peminjaman` = '$kode_peminjaman'";
                                    ...
                                    <?php while ($data = mysqli_fetch_assoc($query)) :
                                        ...
                                        $judul = $data["judul"];
                                        $jumlah_buku = $data["jumlah_buku"];
                                        $keterangan_denda = $data["keterangan_denda"];
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-dark text-center"><?= $keterangan_denda; ?></td>
                                        <td class="align-middle text-dark text-center"><?= $total_denda; ?></td>
                                    </tr>
                                    <?php $no++; ?>
                                    <?php endwhile; ?>
                                </tbody>
                            ...
                            <?php
                                ...
                                $sql_jum = "SELECT  `detail_peminjaman`.`id_buku`, `detail_peminjaman`.`jumlah_buku`, 
                                                    `detail_peminjaman`.`keterangan_denda`, `detail_peminjaman`.`total_denda`, 
                                                    `buku`.`judul`
                                            FROM `detail_peminjaman` 
                                            INNER JOIN `buku` ON `detail_peminjaman`.`id_buku` = `buku`.`id_buku`  
                            ...
                            <nav aria-label="Page navigation example">
                                ...
                                <?php 
                                    if ($jum_halaman == 0) {
                                        ...
                                        if ($halaman != 1) {
                                        echo "<li class='page-item'><a class='page-link' href='index.php?include=detail-pengembalian&data=" . $kode_peminjaman . "&halaman=1'>First</a></li>";
                                        echo "<li class='page-item'><a class='page-link' href='index.php?include=detail-pengembalian&data=" . $kode_peminjaman . "&halaman=$sebelum'>&laquo;</a></li>";
                                        }
                                        for ($i = 1; $i <= $jum_halaman; $i++) {
                                            if ($i > $halaman - 5 and $i < $halaman + 5 ) {
                                                if ($i != $halaman) { 
                                                    echo "<li class='page-item'><a class='page-link' href='index.php?include=detail-pengembalian&data=" . $kode_peminjaman . "&halaman=$i'>$i</a></li>";
                                                } else {
                                        ...
                                        echo "<li class='page-item'><a class='page-link' href='index.php?include=detail-pengembalian&data=" . $kode_peminjaman . "&halaman=$setelah'>»</a></li>";
                                        echo "<li class='page-item'><a class='page-link' href='index.php?include=detail-pengembalian&data=" . $kode_peminjaman . "&halaman=$jum_halaman'>Last</a></li>";
                                        }          
                                    }
                                ?>
                                </ul>
