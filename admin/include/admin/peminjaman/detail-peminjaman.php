                            ...
                            <nav aria-label="Page navigation example">
                                ...
                                <?php 
                                    if ($jum_halaman == 0) {
                                        ...
                                        if ($halaman != 1) {
                                        echo "<li class='page-item'><a class='page-link' href='index.php?include=detail-peminjaman&data=" . $kode_peminjaman . "&halaman=1'>First</a></li>";
                                        echo "<li class='page-item'><a class='page-link' href='index.php?include=detail-peminjaman&data=" . $kode_peminjaman . "&halaman=$sebelum'>&laquo;</a></li>";
                                        }
                                        for ($i = 1; $i <= $jum_halaman; $i++) {
                                            if ($i > $halaman - 5 and $i < $halaman + 5 ) {
                                                if ($i != $halaman) { 
                                                    echo "<li class='page-item'><a class='page-link' href='index.php?include=detail-peminjaman&data=" . $kode_peminjaman . "&halaman=$i'>$i</a></li>";
                                                } else {
                                        ...
                                        echo "<li class='page-item'><a class='page-link' href='index.php?include=detail-peminjaman&data=" . $kode_peminjaman . "&halaman=$setelah'>»</a></li>";
                                        echo "<li class='page-item'><a class='page-link' href='index.php?include=detail-peminjaman&data=" . $kode_peminjaman . "&halaman=$jum_halaman'>Last</a></li>";
                                        }          
                                    }
                                ?>
                                </ul>
