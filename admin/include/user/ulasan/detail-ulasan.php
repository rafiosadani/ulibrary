        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow border-primary">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-dark card-title">Form Ulasan Peminjaman Buku</h6>
                    <div class="card-tools">
                        <a href="index.php?include=ulasan" class="btn btn-primary btn-sm float-right"><i class="fas fa-fw fa-solid fa-arrow-left"></i> Kembali</a>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="font-size: 13px;">
                                <thead>
                                    ...
                                    <th class="text-dark" width="65%">Judul Buku</th>
                                    <th class="text-dark" width="10%" style="text-align: center;">Jumlah Buku</th>
                                    <th class="text-dark" width="20%" style="text-align: center;">Aksi</th>
                                </thead>
                                <tbody>
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-dark text-center">
                                            <a href="index.php?include=tambah-ulasan&data=<?= $id_buku; ?>&data2=<?= $kode_peminjaman; ?>" class="badge badge-primary"><i class="fas fa-fw fa-comment-alt"></i> Beri Ulasan</a>
                                        </td>
                                    </tr>
                                    <?php $no++; ?>
                                    <?php endwhile; ?>
